...
export default function CreateSubscriptionForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      "subscribe": {
        ...
        "frequencyindays": form.frequencyindays,
  ...
  return (
    ...
    >
      ...
      <TextField label="Frequency in Days" name="frequencyindays" type="number" value={form.frequencyindays} onChange={handleChange} required />
      
      <TextField label="Trial Days (optional)" name="trialdays" type="number" value={form.trialdays} onChange={handleChange}/>
